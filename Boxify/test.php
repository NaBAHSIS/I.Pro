...
<html lang="en" class="no-js">
									...
									<div class="span4 col">	
										...
										<div class="form-group files">
											<div class="col-md-3 col-sm-3 col-xs-12">
												...
												<label class="filecontent" style=" left: 140px;"> <?php echo explode('/',$photo)[2];   ?></label>
											</div>
											<div class="col-md-3 col-sm-3 col-xs-12">
  ...
  application/vnd.openxmlformats-officedocument.wordprocessingml.document"     value="" >
											...
											<label class="filecontent" style=" left: 112px;"> <?php echo  explode('/',$cv)[2];    ?></label>
											</div>
											<div class="col-md-3 col-sm-3 col-xs-12">
  ...
  application/vnd.openxmlformats-officedocument.wordprocessingml.document" >
											...
											<label class="filecontent" style=" left: 112px;"><?php echo  explode('/',$lm)[2];   ?></label>
											</div>
											<div class="col-md-3 col-sm-3 col-xs-12">
...
if ($_FILES['lmup']['size'] == 0 && $_FILES['lmup']['error'] == 0){
	$lm=$lastlm;
}else{
...
if ($_FILES['photoup']['size'] == 0 && $_FILES['photoup']['error'] == 0){
	$photo=$lastph;
}else{
...
if ($_FILES['cvup']['size'] == 0 && $_FILES['cvup']['error'] == 0){
	$cv=$lastcv;
}else{
...
if ($_FILES['autreup']['size'] == 0 && $_FILES['autreup']['error'] == 0){
	$aute=$lastautre;
}else{
