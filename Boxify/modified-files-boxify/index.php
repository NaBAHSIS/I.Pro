...
<html lang="en" class="no-js">
  ...
  application/vnd.openxmlformats-officedocument.wordprocessingml.document" required>
										  ...
										  <input type="text" name="prix" id="prix" value="30 &euro;">
									...
									<div class="span2 col">
										...
										---------------------------------------<br>
										<strong>General enquiries:</strong> info@xxxx.com<br>
										<strong>Support:</strong> support@xxx.com<br>
										---------------------------------------<br>
										Skype: xxxxxx
                                        ...
                                        <form id="paypalForm" action='https://www.paypal.com/cgi-bin/webscr' method='post' name='form'>
												  ...
												  <input type='hidden' name='cancel_return' value='../boxify/index.php?payed=false'>
												  <input type='hidden' name='return' value='../boxify/index.php?payed=true'>
