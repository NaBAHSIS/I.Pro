			...
			<section class="hero">
				...
				<div class="container">
					...
					<div class="row hero-content">
						<div class="col-md-12">
							<h1 class="animated fadeInDown">Gérer votre identité professionnelle en un click en étant présent et cohérent sur les
							principaux réseaux sociaux professionnelle et site d’emploi</h1>
							<!--<a href="http://tympanus.net/codrops/?p=22554" class="use-btn animated fadeInUp">Use it for free</a>--><a href="#about" class="learn-btn animated fadeInUp">Créer mon identité professionnelle <i class="fa fa-arrow-down"></i></a>
						</div>
					</div>
				</div>
			</section>
                                         ...
                                         <div class="col-md-4 col-sm-4 col-xs-12">
											...
											<div class="col-md-12 col-sm-12 col-xs-12">
                                              <div class="form-group prixparent">
												...
												<label class="control-label col-sm-2" for="pix">Prix:</label>
											...
											<div class="col-md-12 col-sm-12 col-xs-12">
										       <p><a href="#commande" class="arrow-btn">Transférer mes documents <i class="fa fa-long-arrow-right"></i></a></p>
										   </div>
                                            </div>
                                            <div class="col-md-4 col-sm-4 col-xs-12"></div>
                                            </div>
  ...
  application/vnd.openxmlformats-officedocument.wordprocessingml.document" required>
									...
									<div class="span2 col">
                                        ...
                                        <form id="paypalForm" action='https://www.paypal.com/cgi-bin/webscr' method='post' name='form'>
												  ...
												  <input id="dyprice" type='hidden' name='amount' value='20'>
